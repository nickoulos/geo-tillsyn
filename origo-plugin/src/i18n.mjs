...
export const TEXTS = {
  sv: {
    ...
    utanforStrandskydd: 'Utanför zon',
    zon: (ref) => `zon ${ref}`,
  ...
  en: {
    ...
    utanforStrandskydd: 'Outside zone',
    zon: (ref) => `zone ${ref}`,
...
export const MEDDELANDEN = {
  sv: {
    ...
    'resonemang.f7_inom_zon': () => 'Ligger byggnaden inom strandskyddszon?',
    'resonemang.f7_gallde_vid_uppforande': () => 'Gällde strandskyddet när byggnaden uppfördes?',
    'resonemang.f7_dispens_idag': () => 'Krävs dispens för åtgärder i dag?',
    'resonemang.f7_preskription': () => 'Preskriberas överträdelser av strandskyddet?',
    'resonemang.f1_nar_uppford': () => 'När uppfördes byggnaden, enligt bildserien?',
    'resonemang.f1_forenligt_register': () => 'Är dateringen förenlig med registrets nybyggnadsår?',
    'resonemang.f1_bygglov_kravdes': () => 'Krävdes bygglov vid uppförandet?',
    'resonemang.f1_lovbefrielse': () => 'Gäller någon lovbefrielse?',
    'resonemang.f1_klocka_rattelse': () => 'Är rättelsekravet preskriberat?',
    'resonemang.f1_klocka_sanktion': () => 'Är sanktionsavgift fortfarande möjlig?',
    'resonemang.f3_lov_finns': () => 'Finns ett beviljat lov för byggnaden?',
    'resonemang.f3_vilken_lag': () => 'Vilken lag styr lovet?',
    'resonemang.f3_korskontroll': () => 'Stämmer den skannade handlingen med registerposten?',
    'resonemang.f3_avvikelse': () => 'Hur stor är avvikelsen mot godkänt läge?',
    'resonemang.f3_vasentlighet': () => 'Är avvikelsen väsentlig eller ringa?',
    'resonemang.f3_klockor': () => 'Har PBL-klockorna löpt ut?',
    'resonemang.beslut': () => 'Beslut?',
  ...
  en: {
    ...
    'resonemang.f7_inom_zon': () => 'Is the building inside a shoreline protection zone?',
    'resonemang.f7_gallde_vid_uppforande': () => 'Did shoreline protection apply when the building was erected?',
    'resonemang.f7_dispens_idag': () => 'Is an exemption required for measures today?',
    'resonemang.f7_preskription': () => 'Do shoreline protection violations expire?',
    'resonemang.f1_nar_uppford': () => 'When was the building erected, according to the image series?',
    'resonemang.f1_forenligt_register': () => 'Is the dating consistent with the register construction year?',
    'resonemang.f1_bygglov_kravdes': () => 'Was a building permit required at construction?',
    'resonemang.f1_lovbefrielse': () => 'Does any permit exemption apply?',
    'resonemang.f1_klocka_rattelse': () => 'Is the rectification claim time-barred?',
    'resonemang.f1_klocka_sanktion': () => 'Is a sanction fee still possible?',
    'resonemang.f3_lov_finns': () => 'Is there a granted permit for the building?',
    'resonemang.f3_vilken_lag': () => 'Which act governs the permit?',
    'resonemang.f3_korskontroll': () => 'Does the scanned document match the register entry?',
    'resonemang.f3_avvikelse': () => 'How large is the deviation from the approved position?',
    'resonemang.f3_vasentlighet': () => 'Is the deviation material or minor?',
    'resonemang.f3_klockor': () => 'Have the Planning and Building Act clocks expired?',
    'resonemang.beslut': () => 'Decision?',
    'server.parametrar_ogiltiga': (p) =>
